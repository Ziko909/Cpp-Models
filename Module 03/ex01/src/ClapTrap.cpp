...
/*   Updated: 2022/12/18 00:00:00 by zaabou           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include <ClapTrap.hpp>

ClapTrap::ClapTrap() : mName("none"), mHitPoints(100), mEnergyPoints(50), mAttackDamage(20)
{
	std::cout << "ClapTrap : Default Constructor Called" << std::endl;
}

ClapTrap::ClapTrap( std::string name ) : mName(name), mHitPoints(100), mEnergyPoints(50), mAttackDamage(20)
{
